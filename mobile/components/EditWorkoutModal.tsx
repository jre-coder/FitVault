...
import { BodyPart, SourceType, WorkoutItem } from '../types'
...
export default function EditWorkoutModal({ workout, onClose }: EditWorkoutModalProps) {
  ...
  const [url, setUrl] = useState(workout.url)
  const [sourceType, setSourceType] = useState<SourceType>(workout.sourceType)
  const [selectedBodyParts, setSelectedBodyParts] = useState<BodyPart[]>(workout.bodyParts)
  ...
  const handleSave = useCallback(() => {
    ...
    onClose()
  }, [title, url, sourceType, selectedBodyParts, notes, workout.id, updateWorkout, onClose])
